...
class DepositController extends Controller
{
    ...
    protected function depositData($scope = null,$summery = false)
    {
        ...
        $deposits = $deposits->where('order_number', null)->searchable(['trx','user:username'])->dateFilter();
    ...
    {
        $general = gs();
        $deposit = Deposit::where('id', $id)->with(['user', 'gateway', 'booking.service', 'booking.software'])->firstOrFail();
