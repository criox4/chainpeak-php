            ...
            <form action="" method="post">
                ...
                <div class="card-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                            <div>
                                <p class="fw-bold mb-0">@lang('Post Auto Approval')</p>
                                <p class="mb-0">
                                    <small>@lang('If you enable this module, the system will automatically approve all service, job and software related post from users. Otherwise, must be approved manually.') <code>@lang('So be sure before disabling this module that,  the system doesn\'t need to approve posts automatically.')</code></small>
                                </p>
                            </div>
                            <div class="form-group">
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="post_approval" @if($general->post_approval) checked @endif>
                            </div>
                        </li>
