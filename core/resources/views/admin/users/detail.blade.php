            ...
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--primary">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $general->cur_sym }}{{ showAmount($widgetCount['total_deposit']) }}</h3>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--1">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $general->cur_sym }}{{ showAmount($widgetCount['total_withdraw']) }}</h3>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--17">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ $widgetCount['total_transactions'] }}</h3>
                ...
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--3">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ getAmount($widgetCount['total_software']) }}</h3>
                            <p class="text-white">@lang('Total Software')</p>
                        </div>
                        <a href="{{ route('admin.software.all') }}?user_id={{ $user->id }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--13">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ getAmount($widgetCount['total_job']) }}</h3>
                            <p class="text-white">@lang('Total Job')</p>
                        </div>
                        <a href="{{ route('admin.job.all') }}?user_id={{ $user->id }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--15">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ getAmount($widgetCount['total_service']) }}</h3>
                            <p class="text-white">@lang('Total Service')</p>
                        </div>
                        <a href="{{ route('admin.service.all') }}?user_id={{ $user->id }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
                <div class="col-xxl-3 col-sm-6">
                    <div class="widget-two style--two box--shadow2 b-radius--5 bg--18">
                        ...
                        <div class="widget-two__content">
                            <h3 class="text-white">{{ getAmount($widgetCount['total_service_booking']) }}</h3>
                            <p class="text-white">@lang('Total Service Booking')</p>
                        </div>
                        <a href="{{ route('admin.booking.service.completed') }}?buyer_id={{ $user->id }}" class="widget-two__btn">@lang('View All')</a>
                    </div>
                </div>
            </div>
